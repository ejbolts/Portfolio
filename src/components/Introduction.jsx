  ...
  return (
    <div className="flex items-center flex-col pt-5 pb-10 text-center">
      ...
      <div className="md:max-w-2xl  lg:max-w-5xl pt-5  ">
        <div className="max-w-sm  bg-white dark:bg-zinc-900   shadow-lg  md:max-w-2xl  duration-300">
          <div className="md:flex">
            <div className="md:shrink-0">
              <img
                className="h-80 w-full md:rounded-l-lg max-sm:rounded-t-lg object-cover md:h-full md:w-48"
                src={IntroIMG}
