      ...
      <div className="flex mx-auto max-w-2xl  lg:max-w-5xl pt-5  ">
        <div className="max-w-sm mx-auto bg-white dark:bg-zinc-900 rounded-lg   shadow-lg  overflow-hidden md:max-w-2xl  duration-300">
          <div className="md:flex">
            ...
            <div className="p-8 md:rounded-r-lg max-sm:rounded-b-lg md:border-y-2 border-r-2 max-sm:border-x-2 sm:border-x-2 border-b-2 border-white  dark:border-zinc-700 text-gray-600  duration-300">
