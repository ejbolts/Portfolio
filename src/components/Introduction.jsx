...
const Introdcution = () => {
  return (
    <div className="flex items-center flex-col pt-5 pb-10 text-center">
      <h1 className="text-5xl md:text-6xl md:mb-5 font-black dark:text-white  duration-300">
        Ethan Bolton
      </h1>
      <div className="md:max-w-2xl  lg:max-w-5xl pt-5  ">
        <div className="max-w-sm  bg-white dark:bg-zinc-900 rounded-lg   shadow-lg  md:max-w-2xl  duration-300">
          <div className="md:flex">
            ...
            <div className="p-8 md:rounded-r-lg max-sm:rounded-b-lg md:border-y-2 border-r-2 sm:border-x-2 border-b-2 border-white  dark:border-zinc-700  duration-300">
